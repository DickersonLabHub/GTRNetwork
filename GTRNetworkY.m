function [ Prediction TFA Z M] = GTRNetworkY( Expression, Regulatory,TFA_infer,Relatedness_infer,CLR,Network_size,Operon,Binding_site)
%   GTRNetowk Algorithm to reconstruct gene regulatory networks
%   by Fu, Yao(Al)

% Predict TFA
TFA=GetTFAY(Expression, Regulatory, TFA_infer);
